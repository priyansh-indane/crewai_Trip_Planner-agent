# crewai_Trip_Planner-agent
# crewai_Trip_Planner-agent

Agentic AI trip planner using CrewAI to coordinate specialized agents for destination research, logistics, and day-by-day scheduling. The final trip plan is automatically sent to the user via email.
